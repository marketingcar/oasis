import React from 'react';
    ...
    const TermsAndConditions = () => {
      return (
        <>
          <Helmet>
            <title>Terms & Conditions - Oasis Health Services</title>
            <meta name="description" content="Read the Terms and Conditions for using the services of Oasis Health Services." />
          </Helmet>
